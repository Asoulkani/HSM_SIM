...
* The original package name 'ma.soultech.hsm-sim-core' is invalid and this project uses 'ma.soultech.hsmsimcore' instead.
...
```
$ docker run --rm hsm-sim-core:0.0.1-SNAPSHOT
```
